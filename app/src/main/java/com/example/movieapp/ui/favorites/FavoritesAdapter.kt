...
class FavoritesAdapter(private val clickListener: MovieListAdapter.FavoritesListener,) : ListAdapter<Movie, FavoritesAdapter.FavoritesViewHolder>(FavoritesListUtil()) {
